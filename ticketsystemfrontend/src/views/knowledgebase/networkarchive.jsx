        ...
        const fetchData = async () => {
            try {
                ...
                if (all.data && Array.isArray(all.data)) {
                    setFaqData(
                        all.data
                            .filter(item => item.is_active === false && item.kb_category === "network")
                            .map(item => ({
                                id: item.kb_id,
    ...
    const handleDelete = async (id) => {
        ...
        if (window.confirm("Are you sure you want to delete ?")) {
            try {
                ...
                console.error("Error deleting Network troubleshooting step:", err);
                setError("Failed to delete Network troubleshooting step.");
            }
        }
    }
